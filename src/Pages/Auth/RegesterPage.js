...
function RegesterPage() {
   const [name, email, phone, password, confirmPassword, loading, onChangeConfirmPassword, onChangePassword, onChangePhone, onChangeEmail, onChangeName, onSubmit] = RegisterHook()
      return (
